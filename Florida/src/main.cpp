...
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // FloridaCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "FloridaCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 30 * 20; // FloridaCoin: every 20 blocks
static const int64 nTargetSpacing = 30; // FloridaCoin: 30 second blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal FloridaCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "FloridaCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1395509320;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2735250;
        ...
        assert(block.hashMerkleRoot == uint256("0x8c918f816ea91ab48e6a6188bc20a8bc0e34e43e38af0623471a94f8b023bc25"));
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // FloridaCoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
